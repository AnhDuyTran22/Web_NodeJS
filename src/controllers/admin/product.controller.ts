...
import { createProduct, handleDeleteProduct, getProductById, updateProductById } from "../../services/admin/product.service";
...
const postUpdateProduct = async (req: Request, res: Response) => {
    ...
    // Lấy ảnh mới nếu có upload, nếu không thì null
